...
import { Media, Container, Form, Row, Col, Input } from "reactstrap";
...
const CheckoutPage = () => {
  ...
  const [dummyPaymentDetails, setDummyPaymentDetails] = useState({
    cardNumber: '',
    expiryDate: '',
    cvv: ''
  });
  ...
  const handleDummyPaymentInputChange = (e) => {
    const { name, value } = e.target;
    setDummyPaymentDetails({ ...dummyPaymentDetails, [name]: value });
  };
                  ...
                  {cartItems && cartItems.length > 0 ? (
                    <div className="checkout-details">
                      ...
                      <div className="payment-box">
                        <div className="upper-box">
                          <div className="payment-options">
                            <ul>
                              ...
                              <li>
                                <div className="radio-option dummy">
                                  <input
                                    type="radio"
                                    name="payment-group"
                                    id="payment-3"
                                    onClick={() => checkhandle("dummy")}
                                  />
                                  <label htmlFor="payment-3">Dummy Payment</label>
                                </div>
                              </li>
                            </ul>
                          </div>
                        ...
                        {payment === "dummy" && (
                          <div className="dummy-payment-fields">
                            <div className="form-group">
                              ...
                              <Input
                                ...
                                id="cardNumber"
                                name="cardNumber"
                                value={dummyPaymentDetails.cardNumber}
                                onChange={handleDummyPaymentInputChange}
                                required
                              />
                            </div>
                            <div className="form-group">
                              ...
                              <Input
                                ...
                                id="expiryDate"
                                name="expiryDate"
                                value={dummyPaymentDetails.expiryDate}
                                onChange={handleDummyPaymentInputChange}
                                required
                              />
                            </div>
